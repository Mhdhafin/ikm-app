                        ...
                        {auth.user ? (
                            <div>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-3 px-4 py-2 bg-card border border-border rounded-xl hover:border-primary transition-all hover:shadow-md cursor-pointer"
                                >
                ...
                {isOpen && (
                    ...
                    <button
                        ...
                        <span>Pengaturan</span>
                                ...
                                <button
                                    onClick={handleLogout}
                                    className="w-full cursor-pointer px-4 py-2 flex items-center gap-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors text-left font-medium"
                                >
                                    <LogOut size={16} />
                                    <span>Logout</span>
                                </button>
