        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <Link href="#forum" className="text-foreground hover:text-primary transition-colors">
                    Forum Diskusi
                    </Link>
                    <Link href="/halal" className="text-foreground hover:text-primary transition-colors">
                    Sertifikasi Halal
                    </Link>
                    <Link href="#konsultasi" className="text-foreground hover:text-primary transition-colors">
                    Konsultasi
                    </Link>
                    <Link href="#artikel" className="text-foreground hover:text-primary transition-colors">
                    Artikel
                    </Link>
                </div>
                ...
                <div className="hidden md:flex items-center relative" ref={userMenuRef}>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            {/* <div className="py-2"> */}
                                {/* <button
                                    className="w-full px-4 py-2 flex items-center gap-3 text-foreground hover:bg-muted transition-colors text-left">
                                    <User size={18} className="text-primary" />
            ...
            <div className="md:hidden pb-4 space-y-2">
                ...
                <div className="space-y-2 border-t border-border pt-4">
                    ...
                    {/* <button
                        className="w-full px-4 py-2 flex items-center gap-2 text-foreground hover:bg-muted rounded-lg transition-colors text-left">
                ...
                <button
                    className="w-full px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors mt-2">
                    <Link href="/login">Login / Register</Link>
                </button>
                )}
            </div>
