    ...
    const features = [
        {
            ...
            description:
                "Informasi dan panduan lengkap untuk sertifikasi halal produk Anda.",
        ...
        },
        {
            ...
            title: "Forum Diskusi",
            description:
                "Diskusi dan kolaborasi antara IKM dan mahasiswa untuk berbagi wawasan.",
        ...
        },
        {
            ...
            description:
                "Panduan dan cara mendapatkan NIB dengan mudah dan cepat.",
            buttonText: "Selengkapnya",
            buttonLink: "#nib",
        ...
        },
        {
            ...
            description:
                "Laporan dan riset terkini untuk pengembangan usaha IKM Anda.",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((feature, index) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`w-16 h-16 rounded-lg ${feature.color} flex items-center justify-center mb-4 flex-shrink-0`}
                                >
